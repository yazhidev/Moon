...
import com.yazhi1992.moon.adapter.HopeInListViewBinder;
...
public class HopeListActivity extends BaseListActivity<HopeItemDataBean> {
    ...
    public void adapterRegister(MultiTypeAdapter adapter) {
        HopeInListViewBinder hopeInListViewBinder = new HopeInListViewBinder();
        adapter.register(HopeItemDataBean.class, hopeInListViewBinder);
    }
